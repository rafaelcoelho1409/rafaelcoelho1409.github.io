...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/al-folio/";
          ...
          title: "Projects",
          description: "Here are all my portfolio projects I’ve been published in the last years.  My main purpose with all these projects is to get more experience and to deliver new results and values thinking about new and future projects.",
          section: "Navigation",
          handler: () => {
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/articles/index.html";
          },
        },{id: "nav-repositories",
          title: "Repositories",
          description: "",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/_pages/skills/";
          },
        },{id: "nav-cv",
          title: "CV",
          description: "",
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-coelho-finance",
          title: 'COELHO Finance',
          description: "September 2023",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/COELHOFinance/";
            },},{id: "projects-formula-1-analytics",
          title: 'Formula 1 Analytics',
          description: "November 2023",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/FormulaOneAnalytics/";
            },},{id: "projects-coelho-vision",
          title: 'COELHO VISION',
          description: "April 2024",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/COELHOVISION/";
            },},{id: "projects-pentesting-automation",
          title: 'Pentesting Automation',
          description: "July 2024",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/PentestingAutomation/";
            },},{id: "projects-coelho-genai",
          title: 'COELHO GenAI',
          description: "September 2024",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/COELHOGenAI/";
            },},{id: "projects-coelho-agents",
          title: 'COELHO Agents',
          description: "February 2025",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/COELHOAgents/";
            },},{id: "projects-youtube-content-search",
          title: 'YouTube Content Search',
          description: "March 2025",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/YouTubeContentSearch/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%72%61%66%61%65%6C%63%6F%65%6C%68%6F%31%34%30%39@%68%6F%74%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/rafaelcoelho1409", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/rafaelcoelho1409", "_blank");
        },
      },{
      id: 'light-theme',
